...
public class LogCommand implements Command {
    ...
    public String execute(User currentUser, String message, MessageHandler messageHandler) throws InvalidMessageFormatException, EntityDoesNotExistException {
        ...
        toDoListDto.setPlannedOn(LocalDate.now());
        ...
        if (toDoList == null) {
            ...
            return "Новый список успешно создан";
        }

        toDoListService.update(toDoList.getId(), toDoListDto);
        return "Сегодняшний список успешно обновлен";
    }
